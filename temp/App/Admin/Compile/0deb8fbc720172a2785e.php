...
<body style="background:#f0f9fd;">
    ...
    <dd>
    <div class="title">
    <span><img src="http://127.0.0.1/AEshop/./App/Admin/Tpl/Public/images/leftico01.png" /></span>管理信息
    </div>
    	<ul class="menuson">
        <li class="active"><cite></cite><a href="<?php echo U(main);?>" target="rightFrame">首页模版</a><i></i></li>
        <li><cite></cite><a href="<?php echo U('Category/index');?>" target="rightFrame">分类管理</a><i></i></li>
        <li><cite></cite><a href="<?php echo U('Brand/index');?>" target="rightFrame">品牌管理</a><i></i></li>
    ...
    <dd>
    <div class="title">
    <span><img src="http://127.0.0.1/AEshop/./App/Admin/Tpl/Public/images/leftico02.png" /></span>其他设置
    </div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="http://127.0.0.1/AEshop/./App/Admin/Tpl/Public/images/leftico03.png" /></span>编辑器</div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="http://127.0.0.1/AEshop/./App/Admin/Tpl/Public/images/leftico04.png" /></span>日期管理</div>
    <ul class="menuson">
        <li><cite></cite><a href="#">自定义</a><i></i></li>
        <li><cite></cite><a href="#">常用资料</a><i></i></li>
        <li><cite></cite><a href="#">信息列表</a><i></i></li>
