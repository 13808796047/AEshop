...
HTTPREFERER = '<?php echo $GLOBALS['user']['HTTPREFERER'];?>';
    ...
    <script type="text/javascript" src="http://127.0.0.1/AEshop/./App/Admin/Tpl/Category/js/validate.js"></script>
</head>
...
<!--     <div class="place">
    ...
    <ul class="placeul">
        <li>
            <a href="http://127.0.0.1/AEshop/index.php/Admin/Category/edit/cid/1">首页</a>
        </li>
        <li>
...
echo "";
            ...
            <tr>
                <th>分类名称</th>
                <td>
                    <input type="text" name="catname" required="" class="w300" value='<?php echo $field['catname'];?>'/>
                </td>
            </tr>
            <tr>
                <th>导航显示</th>
                <td>
                    ...
                    <label>
                        <input type="radio" name="display" value="1" <?php if($field['display']==1){?>checked="checked"<?php }?>/>
                        是
                    </label>
                     <label>
                        <input type="radio" name="display" value="0" <?php if($field['display']==0){?>checked="checked"<?php }?>/>
                        否
                    </label>
            ...
            <tr>
                <th>分类排序</th>
                <td>
                    <input type='text' name='sort' value='<?php echo $field['sort'];?>' />
                </td>
            </tr>
            <tr>
                ...
                <th>SEO标题</th>
                <td>
                    <input type="text" name="pagetitle"  class="w300" value='<?php echo $field['pagetitle'];?>'/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="pagekeywords" class="w300" value='<?php echo $field['pagekeywords'];?>'/>
                </td>
            </tr>
            <tr>
                ...
                <th>描述</th>
                <td>
                    <textarea name='pagedesc' class='w400 h150'><?php echo $field['pagedesc'];?></textarea>
                </td>
            </tr>
        </table>
